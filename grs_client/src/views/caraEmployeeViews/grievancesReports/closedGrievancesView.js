...
const ClosedGrievancesView = () => {
    const [loadingOverlay, setLoadingOverlay] = useState(false);
    const [allGrievances, setAllGrievances] = useState([]);
    //const [caraDepts, setCaraDepts] = useState([]);

    const columns = [
        // { field: 'email_token', headerName: 'Grievance Token', width: 150 },
        ...
        //     ),
        // },
        { field: 'email_subject', headerName: 'Subject', width: 100 },
        { field: 'applicant_email_id', headerName: 'Body', width: 200 },
        { field: 'email_category', headerName: 'Categories', width: 200 },
...
export default ClosedGrievancesView;